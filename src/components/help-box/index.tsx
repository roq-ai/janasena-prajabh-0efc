...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Party Chief'];
  const customerRoles: string[] = ['Citizen'];
  const tenantRoles: string[] = ['Party Chief', 'Party Member', 'Volunteer', 'Event Coordinator'];
  const addOns: string[] = ['file', 'chat', 'notifications'];
  const applicationName = `JANASENA PRAJABHIPRAYA`;
  const tenantName = `Janasena`;
