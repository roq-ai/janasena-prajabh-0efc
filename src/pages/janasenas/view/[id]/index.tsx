...
import { getJanasenaById } from 'apiSdk/janasenas';
...
function JanasenaViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<JanasenaInterface>(
    ...
    () =>
      getJanasenaById(id, {
        relations: ['user', 'event', 'suggestion'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Janasena Detail View
          </Text>
          {hasAccess('janasena', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/janasenas/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('event', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/events/create?janasena_id=${data?.id}`}>
              ...
              {hasAccess('suggestion', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/suggestions/create?janasena_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
