            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('janasena', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>janasena</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('janasena', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/janasenas/view/${record.janasena?.id}`}>
                          {record.janasena?.name}
                        </Link>
                      </Td>
                    )}
